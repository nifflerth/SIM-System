...
<script type="text/javascript" charset="utf-8"> 
	...
	function choose_course () {
		if(($("#inputyear").val() != '') && ( $("#selectclass").val() != '' ) && ($("#selectroom").val() != '') && ($("#selectpart").val() != '')){
		    ...
		    form.setAttribute('action', '<?=base_url('index.php');?>/course/v_activity/'+$("#inputyear").val()+'/'+$("#selectclass").val()+'/'+$("#selectroom").val()+'/'+$("#selectpart").val());
			...
			var form = document.createElement('form');
		    form.setAttribute('method', 'post');
		    form.setAttribute('action', '<?=base_url('index.php');?>/course/manage_activity/err1');
		    form.style.display = 'hidden';
		    document.body.appendChild(form)
		    form.submit();
		...
		<div class="content">
			<div class="row-fluid">
				<div class="span12">
					<div class="box">
						<div class="box-head">
							<h3>Manage Free Activity</h3>
						</div>
						<div class="box-content box-nomargin">
							<? echo form_open('index.php/course/v_activity', $formattr); ?>
								<div class="wizard">
									<h4>Choose a class to manage free activity</h4>
								</div>
								<? 	if($code == 'err2'){
