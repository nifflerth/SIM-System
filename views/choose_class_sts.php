...
<script type="text/javascript" charset="utf-8"> 
	...
	function choose_class () {
		if(($("#inputyear").val() != '') && ($("#selectclass").val() != '') && ($("#selectroom").val() != '')){
		    ...
		    form.setAttribute('action', '<?=base_url('index.php');?>/score/student_sts/'+$("#inputyear").val()+'/'+$("#selectclass").val()+'/'+$("#selectroom").val() );
		    ...
		    form.submit();
		 	...
		 	var form = document.createElement('form');
		    form.setAttribute('method', 'post');
		    form.setAttribute('action', '<?=base_url('index.php');?>/score/status_class/val');
		    form.style.display = 'hidden';
		    document.body.appendChild(form)
		    form.submit();
		}
				...
				<div class="span12">
					<div class="box">
						...
						<div class="box-content box-nomargin">
							<? echo form_open('index.php/score/student_sts/#', $formattr); ?>
								<div class="wizard">
