...
<script type="text/javascript" charset="utf-8"> 
	...
	function choose_class () {
		if(($("#inputyear").val() != '') && ($("#selectclass").val() != '') && ($("#selectroom").val() != '') && ($("#selectpart").val() != '')){
		    ...
		    form.setAttribute('action', '<?=base_url('index.php');?>/score/by_subject/'+$("#inputyear").val()+'/'+$("#selectclass").val()+'/'+$("#selectroom").val()+'/'+$("#selectpart").val() );
		    ...
		    form.submit();
		 	...
		 	var form = document.createElement('form');
		    form.setAttribute('method', 'post');
		    form.setAttribute('action', '<?=base_url('index.php');?>/score/class_student/val');
		    form.style.display = 'hidden';
		    document.body.appendChild(form)
		    form.submit();
		}
				...
				<div class="span12">
					<div class="box">
						...
						<div class="box-content box-nomargin">
							<? echo form_open('index.php/score/class_student/#', $formattr); ?>
								<div class="wizard">
