						...
						<div class="box-content box-nomargin">
							...
							<div class="tab-pane active" id="basic">
								<table id="subject_table" class='table table-striped dataTable table-bordered'> 
									<thead> 
										<tr>
											<th>Subject Code</th><th>Subject Name</th><th>Subject Group</th><th>Subject Type</th><th>Subject Class</th><th>Credit</th><th>Status</th><th>Process</th>
										</tr> 
									</thead> 
									<tbody>
									<?
										foreach($subject as $f){  
											...
											echo "<td><a class='btn btn-mini' href='edit/".$f->subject_id."'><i class='icon-edit'></i>Edit</a> <a class='btn btn-mini' href='view/".$f->subject_id."'><i class='icon-search'></i>View</a></td>";
											echo "</tr>";
										}
									?>
									</tbody>
