					...
					<div class="box">
						...
						<div class="box-content box-nomargin">
							...
							<div class="tab-pane active" id="basic">
								<table id="user_table" class='table table-striped dataTable table-bordered'> 
									<thead> 
										<tr>
											<th>User ID</th><th>Username</th><th>Name</th><th>Surname</th><th>Level</th><th>Status</th><th>Process</th>
										</tr> 
									</thead> 
									<tbody>
									<?
										foreach($user as $f){  
											echo "<tr>";      
											echo "<td>".$f->ACCOUNT_ID."</td>";
											echo "<td>".$f->ACCOUNT_USERNAME."</td>";
											echo "<td>".$f->teacher_name."</td>";
											echo "<td>".$f->teacher_surname."</td>";
											echo "<td>".$f->level_name."</td>";
											if($f->status == 1){
												echo "<td>Active</td>";
											}else{
												echo "<td>Inactive</td>";
											...
											echo "<td><a class='btn btn-mini' href='edituser/".$f->ACCOUNT_ID."'><i class='icon-edit'></i> Edit User</a></td>";
											echo "</tr>";
										}
									?>
									</tbody>
									<tfoot>
										<tr>
											<th>User ID</th><th>Username</th><th>Name</th><th>Surname</th><th>Level</th><th>Status</th><th>Process</th>									</tr>
									</tfoot>
								</table>
								</div>
							</div>
