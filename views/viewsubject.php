...
function edit () {
    ...
    form.setAttribute('action', '<?=base_url('index.php');?>/subject/edit/<? echo $id ?>');
					...
					<div class="box">
						...
						<? echo form_open('index.php/subject/edit', $formattr); ?>
							...
							<div class="control-group">
								...
								<label for="inputcode" class="control-label"><? echo $code ?></label>
							</div>
							<div class="control-group">
								<label for="inputgroup" class="control-label"><? echo $l_grp ?></label>
								<label for="inputgroup" class="control-label"><? echo $group ?></label>
							</div>
							<div class="control-group">
								<label for="inputtype" class="control-label"><? echo $l_type ?></label>
								<label for="inputeype" class="control-label"><? echo $type ?></label>
							</div>
							<div class="control-group">
								<label for="inputtype" class="control-label"><? echo $l_subclass ?></label>
								<label for="inputeype" class="control-label"><? echo $class ?></label>
							</div>
							<div class="control-group">
								<label for="inputname" class="control-label"><? echo $l_name ?></label>
								<label for="inputname" class="control-label"><? echo $name ?></label>
							</div>
							<div class="control-group">
								<label for="inputcredit" class="control-label"><? echo $l_credit ?></label>
								<label for="inputcredit" class="control-label"><? echo $credit ?></label>
							</div>
							<div class="control-group">
								<label for="inputdesc" class="control-label"><? echo $l_desc ?></label>
								<label for="inputdesc" class="control-label"><? echo $desc ?></label>
							</div>
							<div class="control-group">
								<label for="inputstatus" class="control-label"><? echo $l_status ?></label>
								<label for="inputstatus" class="control-label"><? 
								if ($status == 1){ echo 'Active'; }else{ echo 'Inactive'; } ?></label>
							</div>
							<div id="navigation2">
								<div class="form-actions">
									<button class="btn btn-primary" type="button" onclick="edit();">Edit Subject</button>
								</div>
							</div>
