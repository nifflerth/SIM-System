...
<script type="text/javascript" charset="utf-8"> 
	...
	function choose_class () {
		if(($("#inputyear").val() != '') && ($("#selectclass").val() != '') && ($("#selectroom").val() != '') && ($("#selectpart").val() != '')){
		    ...
		    form.setAttribute('action', '<?=base_url('index.php');?>/score/choose_activity/'+$("#inputyear").val()+'/'+$("#selectclass").val()+'/'+$("#selectroom").val()+'/'+$("#selectpart").val() );
		    ...
		    form.submit();
		 	...
		 	var form = document.createElement('form');
		    form.setAttribute('method', 'post');
		    form.setAttribute('action', '<?=base_url('index.php');?>/score/manage_activity/val');
		    form.style.display = 'hidden';
		    document.body.appendChild(form)
		    form.submit();
		}
				...
				<div class="span12">
					<div class="box">
						...
						<div class="box-content box-nomargin">
							<? echo form_open('index.php/score/choose_activity/#', $formattr); ?>
								<div class="wizard">
								...
								<? 	if($code == 'err1'){
										...
										echo "<div class='alert alert-error'>";
  										echo 'Please enter a valid class information';
										echo "</div><br>";
