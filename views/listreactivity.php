						...
						<div class="box-content box-nomargin">
							...
							<div class="tab-pane active" id="basic">
								<table id="subject_table" class='table table-striped dataTable table-bordered'> 
									<thead> 
										<tr>
											<th>Activity Class</th><th>Activity Name</th><th>Hour</th><th>Status</th><th>Process</th>
										</tr> 
									</thead> 
									<tbody>
									<?
										foreach($activity as $f){  
											...
											echo "</td>";
											echo "<td><a class='btn btn-mini' href='edit_ac/".$f->activity_id."'><i class='icon-edit'></i>Edit</a></td>";
											echo "</tr>";
										}
									?>
									</tbody>
