						...
						<div class="box-content box-nomargin">
							...
							<div class="tab-pane active" id="basic">
								<table id="subject_table" class='table table-striped dataTable table-bordered'> 
									<thead> 
										<tr>
											<th>Prefix</th><th>Student ID</th><th>Name</th><th>Surname</th><th>Status</th><th>Process</th>												</tr> 
									</thead> 
									<tbody>
									<?
										foreach($student as $f){  
											...
											echo "<td><a class='btn btn-mini' href='/index.php/student/edit/".$f->student_id."'><i class='icon-edit'></i>Edit</a> <a class='btn btn-mini' href='/index.php/student/view/".$f->student_id."'><i class='icon-search'></i>View</a> <a class='btn btn-mini' href='/index.php/student/print/".$f->student_id."'><i class='icon-print'></i>Print</a></td>";
											echo "</tr>";
										}
									?>
									</tbody>
									<tfoot>
										<tr>
											<th>Prefix</th><th>Student ID</th><th>Name</th><th>Surname</th><th>Status</th><th>Process</th>
										</tr>
									</tfoot>
								</table>
								</div>
