			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box">
						...
						<? echo form_open('index.php/subject/inputac', $formattr); ?>
						<div class="wizard">
							<h4>Activity Information</h4>
						</div>
						
						<div class="control-group">
							<label for="inputname" class="control-label"><? echo t_req.$l_acname ?></label>
							<div class="controls">
								<input type="text" name="inputname" id="inputname" required="required" maxlength="125" class="input-large">
							</div>
						</div>
						<? if($data['ac_role'] <= 3){
							echo '<div class="control-group">';
								echo '<label for="inputtype" class="control-label">';
							    echo $l_acclass;
								echo '</label>';
								echo '<div class="controls">';
									echo "<select name='inputclass' id='inputclass'>";
									echo "<option value=''>Free Activity</option>";
						...
						<div class="control-group">
							<label for="inputhour" class="control-label"><? echo $l_hour ?></label>
							<div class="controls">
							...
							<!--div class="controls">
								<input type="number" name="inputhour" id="inputhour" required="required" maxlength="2" class="input-small" min="1" max="50" step="1">
							</div-->
						</div>
