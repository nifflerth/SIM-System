...
<script type="text/javascript" charset="utf-8"> 
	...
	function choose_course () {
		if(($("#inputyear").val() != '') && ( $("#selectclass").val() != '' ) && ($("#selectroom").val() != '')){
		    ...
		    form.setAttribute('action', '<?=base_url('index.php');?>/course/v_course_class/'+$("#inputyear").val()+'/'+$("#selectclass").val()+'/'+$("#selectroom").val());
			...
			var form = document.createElement('form');
		    form.setAttribute('method', 'post');
		    form.setAttribute('action', '<?=base_url('index.php');?>/course/manage_course/err2');
		    form.style.display = 'hidden';
		    document.body.appendChild(form)
		    form.submit();
				...
				<div class="span12">
					<div class="box">
						...
						<div class="box-content box-nomargin">
							<? echo form_open('index.php/course/v_course_class', $formattr); ?>
								<div class="wizard">
									<h4>Choose a class to manage course</h4>
								</div>
								<? 	if($exist == 'err1'){
